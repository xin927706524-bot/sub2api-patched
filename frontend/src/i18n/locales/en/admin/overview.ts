export default {
    ...
    groups: {
      ...
      form: {
        ...
        displayRateMultiplier: 'User-facing Multiplier',
        displayRateMultiplierHint: 'Display only; leave blank to follow the billing rate. Does not affect billing, scheduling, or usage records.',
        displayTokenMultiplier: 'User-facing Token Multiplier',
        displayTokenMultiplierHint: 'Changes Token counts in user usage details only. Blank means 1.0; billing, limits, and admin statistics remain unchanged.',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
