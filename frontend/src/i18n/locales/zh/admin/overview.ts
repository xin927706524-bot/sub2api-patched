export default {
    ...
    groups: {
      ...
      form: {
        ...
        displayRateMultiplier: '用户展示倍率',
        displayRateMultiplierHint: '仅替换用户页面展示；留空时跟随实际费率，不参与计费、调度或账单',
        displayTokenMultiplier: '用户 Token 展示倍率',
        displayTokenMultiplierHint: '仅替换用户用量明细中的 Token 数量；留空按 1.0 展示，不改变计费、限流或后台统计',
        rpmLimit: '每分钟请求数 (RPM)',
        rpmLimitPlaceholder: '0 表示不限制',
